...
export BAR_COLOR=0xff282828       # Darkest background
export ITEM_BG_COLOR=0xff3c3836       # Medium background
export ACCENT_COLOR=0xffebdbb2     # Gruvbox Material orange
export ICON_COLOR=0xffebdbb2 #Gruvbox Material yellow
export LABEL_COLOR=0xffebdbb2     # Gruvbox Material white
export ITEM_HIGHLIGHT_COLOR=0xff83a598 # Gruvbox Material blue
